...
let OrdersController = class OrdersController {
    ...
    async create(body, user) {
        return await this.ordersService.create(body, user.tenantId);
    }
    async findAll(outletId, status, orderType, startDate, endDate, user) {
        const data = await this.ordersService.findAll(user.tenantId, outletId, status, orderType, startDate ? new Date(startDate) : undefined, endDate ? new Date(endDate) : undefined);
    ...
    async updateStatus(id, body, user) {
        return await this.ordersService.updateStatus(id, body.status, user.tenantId);
    }
    async update(id, body, user) {
        return await this.ordersService.update(id, body, user.tenantId);
    }
...
__decorate([
    ...
    __param(5, (0, auth_decorators_1.AuthenticatedUser)()),
    __metadata("design:type", Function),
