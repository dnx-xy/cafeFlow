...
export default function OrderConfirmationPage() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "My Order",
        text: `I just placed an order! Order #${orderDetails?.orderId}`,
      });
    }
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="px-4 pb-24">
            ...
            <div className="mt-4 flex items-center gap-4 border-t border-border pt-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold">{orderDetails?.estimatedTime || '15-20 min'}</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-amber-100">
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">You are now 5 points away from a free coffee</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="rounded-lg bg-muted p-3 text-center">
          <p className="text-xs text-muted-foreground">We will notify you when your order is ready</p>
        </div>
      </div>
